# -*- coding: utf-8 -*-
"""
Created on Fri Nov  1 10:23:29 2019
...
def consulta():  # A CLASS PRINCIPAL
    ...
    while(True):
        ...
        try:
            response = requests.get('https://free-proxy-list.net/', headers={'User-Agent':'Mozilla/5.0'})
    ...
    selector = 'html > body > div > div > div > div > div > div > div > div > div > .xpdopen'
    ...
    if xpdopen.shape != (0,):
        ...
        ###################################################################################################################
        soup = BeautifulSoup(response.text)
        selector = 'html > body > div > div > div > div > div > div > div > div > div > div > div > div > div > div > div > div > div > div > div > span'
        ...
        if found!=[]:
            ...
            ###################################################################################################################
            soup = BeautifulSoup(response.text)
            selector = 'html > body > div > div > div > div > div > div > div > div > div > div > div > div > div > div > div > div > div > span > span > span'
            ...
            if phones!=[]:
                ...
                if (name == q or confirma_cep or confirma_phone):                
                    ...
                    soup = BeautifulSoup(response.text)
                    selector = 'html > body > div > div > div > div > div > div > div > div > div > div > div > div > div > div > div > div > div > div > div > div > a'
                    found = (soup.select(selector))
                    if found!=[]:
                        link=found[0]['href']
                        link=link.split('/')
